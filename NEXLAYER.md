...
**Live:** [https://relaxed-weasel-listmonk.cloud.nexlayer.ai](https://relaxed-weasel-listmonk.cloud.nexlayer.ai)  
...
**listmonk** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/listmonk/listmonk:latest
    path: /
    servicePorts:
    - 9000
    vars:
      LISTMONK_app__address: "0.0.0.0:9000"
      LISTMONK_db__host: listmonk-postgres-service
